...
@NamedQueries({@NamedQuery(name = "SecretariaAcademica.findByIdSecretariaAcademica", query = "SELECT s FROM SecretariaAcademica s WHERE s.idSecretariaAcademica = :idSecretariaAcademica")})
