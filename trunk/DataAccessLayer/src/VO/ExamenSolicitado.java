...
@NamedQueries(
{
    ...
    @NamedQuery(name = "ExamenSolicitado.consultarExamenSolicitadoEspecifico", query = "SELECT p from ExamenSolicitado p WHERE p.idAnalista = :analis AND p.idRegistro = :reg AND p.idExamen = :exam"),
